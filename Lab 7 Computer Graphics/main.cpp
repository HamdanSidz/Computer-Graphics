...
public:
	...
	Spider(Point2 pos) {
		...
		string fname[2] = { "C:\\Users\\Home\\Desktop\\Varsity work hamdan\\Computer Graphics\\Coding Folder\\Lab 7 Computer Graphics\\spider1.bmp", "C:\\Users\\Home\\Desktop\\Varsity work hamdan\\Computer Graphics\\Coding Folder\\Lab 7 Computer Graphics\\splash.bmp"}; // Replace with actual image filenames
		for (int i = 0; i < 2; i++) {
